      ...
      for(repet in 1:B){ # repet <- 1
        ...
        if(DGP=="DGP1"){
          ...
          result_EYes_AYes <- ReconstPoFD::reconstructKneipLiebl(Ly           = Y_list, 
                                                                 ...
                                                                 nRegGrid     = nRegGrid, 
                                                                 maxbins      = 100)
          Y_EYes_AYes[,repet] <- matrix(unlist(result_EYes_AYes[['Y_reconst_list']]), nrow = nRegGrid, ncol = 1) 
          ##
          ...
          result_EYes_ANo <- ReconstPoFD::reconstructKneipLiebl(Ly           = Y_list, 
                                                                ...
                                                                nRegGrid     = nRegGrid, 
                                                                maxbins      = 100)
          Y_EYes_ANo[,repet] <- matrix(unlist(result_EYes_ANo[['Y_reconst_list']]), nrow = nRegGrid, ncol = 1) 
          ##
          ## Reconstruction operator for noisy fragments with alignment at pre-smoothed fragment
          result_EYes_AYes_CES <- ReconstPoFD::reconstructKneipLiebl(Ly           = Y_list, 
                                                                     ...
                                                                     nRegGrid     = nRegGrid, 
                                                                     maxbins      = 100)
          Y_EYes_AYes_CES[,repet] <- matrix(unlist(result_EYes_AYes_CES[['Y_reconst_list']]), nrow = nRegGrid, ncol = 1) 
          ##
          ## Reconstruction operator for noisy fragments without alignment
          result_EYes_ANo_CES <- ReconstPoFD::reconstructKneipLiebl(Ly           = Y_list, 
                                                                    ...
                                                                    nRegGrid     = nRegGrid, 
                                                                    maxbins      = 100)
          Y_EYes_ANo_CES[,repet] <- matrix(unlist(result_EYes_ANo_CES[['Y_reconst_list']]), nrow = nRegGrid, ncol = 1) 
          ## 
        ...
        if(any(DGP==c("DGP2", "DGP3"))){
          ...
          result_ENo_CG_AYes    <- ReconstPoFD::reconstructKneipLiebl(Ly           = Y_list, 
                                                                      ...
                                                                      reconst_fcts = 1, 
                                                                      nRegGrid     = nRegGrid)
          Y_ENo_CG_AYes[,repet] <- matrix(unlist(result_ENo_CG_AYes[['Y_reconst_list']]), nrow = nRegGrid, ncol = 1) 
          ##
          ...
          result_ENo_CG_ANo     <- ReconstPoFD::reconstructKneipLiebl(Ly           = Y_list, 
                                                                      ...
                                                                      reconst_fcts = 1, 
                                                                      nRegGrid     = nRegGrid)
          Y_ENo_CG_ANo[,repet] <- matrix(unlist(result_ENo_CG_ANo[['Y_reconst_list']]), nrow = nRegGrid, ncol = 1) 
          ##
